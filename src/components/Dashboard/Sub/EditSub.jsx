...
const Add = () => {
    ...
    const URL = `http://ts3ra.runasp.net/api/SubCategory/UpdateSubCategory/${id}`;
            ...
            <div className='flex flex-col items-center gap-16 w-full p-16 '>
                ...
                <div className='w-1/2 justify-center'>
                    <form className='flex flex-col border-solid border border-black p-16 rounded-xl gap-4'>
                        ...
                        <input className='text-gray-500  h-12 pl-2 borderb' placeholder='Subcategory Name' value={product.sUbCategoryName} onChange={(e) => setProduct({ ...product, sUbCategoryName: e.target.value })} />
                        <input className='text-gray-500  h-12 pl-2 borderb' placeholder='Subcategory Name' value={id} onChange={(e) => setID( e.target.value )} />
                        <input className='text-gray-500  h-12 pl-2 borderb' placeholder='Category ID' value={product.category_ID} onChange={(e) => setProduct({ ...product, category_ID: e.target.value })} />
